...
function AddClaims({ parent_container }) {
  ...
  const createClaim = async (event) => {
    ...
    if (attachedDocs) {
              ...
              .then(async () => {
                if (index === arrayOfDocs.length - 1) {
                  await addDoc(claimsCollectionRef, fields)
                    .then(() =>
                      toast.success(
                        `successfully added ${fields.claimantName}'s claim`,
                        { position: "top-center" }
                      )
                    )
                    .then(async () => {
                    ...
                    .catch(async () => {
                      toast.error(
                        `Failed: couldn't added ${fields.claimantName}'s claim`,
                        { position: "top-center" }
                      );
      ...
      await addDoc(claimsCollectionRef, fields)
        .then(() =>
          toast.success(`successfully added ${fields.claimantName}'s claim`, {
            position: "top-center",
          })
        )
        .then(async () => {
        ...
        .catch(async () => {
          toast.error(`Failed: couldn't added ${fields.claimantName}'s claim`, {
            position: "top-center",
          });
          ...
          <Form name="form1" onSubmit={createClaim}>
            <Row className="mb-3">
              ...
              <Form.Group
                ...
                md="4"
              >
                <Form.Label htmlFor="stickerNumber">
                  Reference Number
                </Form.Label>
                <Form.Control
                  type="text"
            ...
            <Row className="mb-3">
              ...
              >
                ...
                <Form.Control
                  ...
                  name=""
                  id="estimate"
                  placeholder="Enter Claim Estimate Amount"
                  onChange={handleFieldChange}
                  required
                />
              </Form.Group>
            ...
            >
              <Form.Label htmlFor="detailsOfIncident">
                Details of Incident
              </Form.Label>
              <Form.Control
                type="text"
            ...
            <Form.Group className="mb-3 mt-3">
              <Form.Label>
                Upload support documents (max: <b>2 files</b>)
              </Form.Label>
              <UploadFile
