...
export default function AddOrganisation({ parent_container }) {
  ...
  useEffect(() => {
    document.title = `Add Organisations ${systemName ? "- " + systemName : ""}`;
  }, []);
            ...
            <div className="organisation-columns">
              <div
                style={{
                  padding: "1rem",
                  paddingRight: "3.5rem",
                  borderRight: "1px solid rgba(198, 199, 200, 0.4)",
                }}
              >
                ...
                <Form.Group className="mb-3">
                  <Form.Label htmlFor="org_email">
                    Organisation Email <span className="required">*</span>
                  </Form.Label>
                  <Form.Control
                    id="org_email"
                    type="email"
              ...
              <div style={{ padding: "1rem" }}>
                ...
                <Form.Group className="mb-3">
                  <Form.Label htmlFor="contactName">
                    Contact's Name <span className="required">*</span>
                  </Form.Label>
                  <Form.Control
                    id="contactName"
                    type="text"
