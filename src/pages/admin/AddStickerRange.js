...
function AddStickerRange({ parent_container }) {
  ...
  const getSupervisors = () => {
    ...
    listUsers()
      .then((results) => {
        const mySupervisors = results.data
  ...
  const handleStickerRange = async (event) => {
    ...
    try {
      ...
      toast.success(`Successfully added sticker Range`, {
        position: "top-center",
      });
  ...
  return (
    <div className="components">
      ...
      <div className="addComponentsData tw-py-4 shadow-sm mb-3">
        {isLoading && (
          ...
          <Row>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                type="text"
                id="total"
                value={rangeTo > 0 ? rangeTo - rangeFrom : ""}
                readOnly
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <datalist id="supervisorNames">
                {supervisors.map((supervisor) => (
                  <option
                    data-value={JSON.stringify(supervisor)}
